...
//                                     <li>이메일</li>
//                                     <li>
//                                         <input onChange={changeEmail} onBlur={checkEmail} className="checkout_input" type="email" placeholder="rlatkdwns@naver.com" value={email} />
//                                     </li>
//                                 </ul>
//                             </div>
//                         </div>
...
// import { AuthContext } from "../context/AuthContext";
import { getAuth, onAuthStateChanged } from "firebase/auth";
import COFormInput from "./checkoutForm/COFormInput";
...
function Checkout() {
    ...
    useEffect(() => {
        const unsubscribe = onAuthStateChanged(auth, (user) => {
            if (user) {
                setInputValues({userName: user.displayName, email: user.email});
            }
        });
        return () => {
            unsubscribe();
                ...
                <div className="checkout_container checkout_contents">
                    ...
                    <div id="checkout_info">
                        ...
                        <div className="checkout_info_title">
                            <h3 className="checkout_info_subtitle">추가 정보</h3>
                            <div className="checkout_info_contents">
                            <COFormInput title={inputs.second[0].title} key={inputs.second[0].id} {...inputs.second[0]} value={inputValues[inputs.second[0].name]} onChange={handleChange} />
                                <ul>
                                    <li>기타사항 (선택 사항)</li>
                                    <li>
                                        <textarea name="" className="checkout_area" id="" cols="100" rows="2" placeholder=" (무통장입금시 이체자 성함 등)"></textarea>
